...
\pagebreak %Only to see how it looks
...
\begin{lstlisting}[caption=Stripe Charge Promisified Example]
...
\begin{lstlisting}[caption=Section Of Migration File: v0.9.0-v0.10.0.sql]
...
\begin{lstlisting}[caption=CreditHistory.js model file]
module.exports = { 
    attributes: {
		//Code omitted
...
\begin{enumerate}
    ...
    \item Adding Waterline functions to CRUD Stripe customer records from the DB.
\end{enumerate}
